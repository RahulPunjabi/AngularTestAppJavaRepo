...
public class CoursesController {
	...
	//update
		@RequestMapping(value="/api/Courses/{courseID}", method=RequestMethod.PUT,consumes=MediaType.APPLICATION_JSON_VALUE)
		@ResponseStatus(value = HttpStatus.OK)
		public void putCourse(@PathVariable Integer courseID, @RequestBody Course course) throws JsonMappingException,JsonParseException,IOException
		{
